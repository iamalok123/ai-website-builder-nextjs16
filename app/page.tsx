...
export default function Home() {
  ...
  return (
    <main className='min-h-screen bg-[#0a0a0a] selection:bg-white/20'>
      ...
      {/* HERO SECTION */}
      <section className="relative h-full flex flex-col items-center overflow-hidden px-4 pb-15 pt-25 text-center">
        < HoleBackground
        ...
        />
        <Badge variant="outline" className="gap-2 p-4 backdrop-blur-sm mb-5">
